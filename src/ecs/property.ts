 ...
 * @class property
 */
export class CopyableProperty<T extends CopyCloneableType> extends Property<T> {
    public constructor(options: CopyCloneableOptions<T>) {
 ...
 */
export function CopyableProp<T extends CopyCloneableType>(
    opts: CopyCloneableOptions<T>
) {
...
export interface CopyCloneableOptions<T> {
    type: Constructor<T>;
    default?: T;
}

export interface CopyCloneableType {
